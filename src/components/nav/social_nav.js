      ...
      <li>
        ...
        >
          ...
          >
            ...
            <g className="icon">
              <path
                d="M28.23,12.13a.06.06,0,0,1,0,0s0-.06,0-.09l0-.05s0,0,0-.08l0,0,0-.07,0-.05L28,11.64l0-.05-.06-.05a.08.08,0,0,0,0,0l-.06-.05a.1.1,0,0,0,0,0h0L16.58,3.94a1.06,1.06,0,0,0-1.16,0L4.23,11.4h0a.1.1,0,0,0,0,0l-.06.05,0,0L4,11.59l0,.05,0,.06,0,.05,0,.07,0,0s0,.05,0,.08l0,.05s0,.06,0,.09a.06.06,0,0,1,0,0s0,.1,0,.14v7.46s0,.09,0,.14a.06.06,0,0,1,0,0s0,.06,0,.09l0,.05s0,.05,0,.08l0,.05,0,.07,0,.05,0,.06,0,.05.06.05a.08.08,0,0,0,0,0l.06.05a.1.1,0,0,0,0,0h0l11.19,7.46a1,1,0,0,0,1.16,0L27.77,20.6h0a.1.1,0,0,0,0,0l.06-.05a.08.08,0,0,0,0,0l.06-.05,0-.05.05-.06,0-.05,0-.07,0-.05s0-.05,0-.08l0-.05s0-.06,0-.09a.06.06,0,0,1,0,0c0-.05,0-.1,0-.14V12.27S28.23,12.18,28.23,12.13ZM17.05,6.78l8.24,5.49-3.68,2.47-4.56-3.05Zm-2.1,0v4.91l-4.56,3.05L6.71,12.27ZM5.87,14.24,8.5,16,5.87,17.76Zm9.08,11L6.71,19.73l3.68-2.46,4.56,3ZM16,18.49,12.28,16,16,13.51,19.72,16Zm1.05,6.73V20.31l4.56-3,3.68,2.46Zm9.08-7.46L23.5,16l2.63-1.76Z"
                transform="translate(0 0)"
              />
            </g>
            <g className="outline">
